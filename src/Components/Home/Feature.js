...
const Feature = () => {
  return (
    <div className="font-family mb-6">
      <div class="mb-6 ">
        {" "}
        <h1 class="text-3xl pt-8 font-bold mx-14 lg:text-center text-white font-family">
          The four main features of TMT
        </h1>
        <p class="py-6 text-lg text-slate-300 font-family lg:w-2/4 mx-4 lg:text-center lg:mx-auto ">
          ...
          <div class="card lg:w-4/6 lg:ml-8 card-side bg-base-100 shadow-xl">
            ...
            <div class="card-body">
              ...
              <p class="text-slate-600 font-family">
                ...
                mail. In this mail, member can see his member id, password and
                team details.
              </p>
            </div>
          </div>
