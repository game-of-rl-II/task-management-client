...
const Register = () => {
  ...
  const handleRegister = async () => {
    ...
    fetch("https://sheltered-wave-69822.herokuapp.com/new-admin", {
      method: "POST",
      headers: {
        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 border-y-4 border-indigo-500">
          <div className="card-body">
            ...
            <div className="form-control mt-6">
              <button onClick={handleRegister} className="btn bg-gradient-to-r from-pink-400 to-orange-500 border-0 ">
                Login
              </button>
            </div>
          </div>
